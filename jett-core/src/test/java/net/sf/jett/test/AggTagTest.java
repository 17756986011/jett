...
public class AggTagTest extends TestCase {
     ...
     * 测试 .xls 模板电子表格。
     *
     * @throws java.io.IOException                                        如果发生 IO 错误。
     * @throws org.apache.poi.openxml4j.exceptions.InvalidFormatException 如果输入的电子表格无效。
     */
    @Override
    @Test
    ...
    protected void check(Workbook workbook) {
        ...
        // 使用“double”的浮点运算会丢失太多精度。以非常高的精度使用 BigDecimals。
