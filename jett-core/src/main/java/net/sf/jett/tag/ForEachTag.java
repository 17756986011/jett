...
public class ForEachTag extends BaseLoopTag {
    ...
    public void validateAttributes() throws TagParseException {
        ...
        logger.info("Collection \"{}\" has size {}", attrItems, myCollection.size());
        ...
        logger.info("vA: myLimit={}", myLimit);
    }
    ...
    protected void beforeBlockProcessed(TagContext context, Block currBlock, Object item, int index) {
        ...
        logger.info("beforeBP: index={}", index);
    ...
    private class ForEachTagIterator implements Iterator<Object> {
        ...
        public Object next() {
            ...
            if (logger.isDebugEnabled()) {
                try {
                    logger.info("ForEachTagIterator: next: \"{}\".", ((next == null) ? "(null)" : next.toString()));
