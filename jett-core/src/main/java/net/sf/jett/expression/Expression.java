...
public class Expression {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child instanceof ASTIdentifier) {
                ...
                if (result instanceof Collection) {
                    ...
                    if (i < count - 1) {
                        ...
                        if (nextChild instanceof ASTMethodNode) {
                            ...
                            if (logger.isDebugEnabled()) {
                                logger.info("      fCN: method.image = {}", methodNode.image);
                                logger.info("      fCN: method.toString = {}", methodNode.toString());
                                int numChildren = methodNode.jjtGetNumChildren();
                                logger.info("      fCN: method.jjtGetNumChildren = {}", numChildren);
                                for (int j = 0; j < numChildren; j++) {
                                    ...
                                    if (methodChild instanceof ASTIdentifier) {
                                        ...
                                        logger.info("  child image = \"{}\".", childIdentifier.image);
                                    }
                                }
                            }
                            ...
                            logger.info("      fCN: Next child is a {}", nextChild.getClass().getName());
                        }
                    } else {
                    ...
                    logger.info("      fCN: Found collection: \"{}\".", collectionName);
    ...
    private static List<Expression> getExpressions(String value) {
        ...
        logger.info("  getExprs: beginIdx = {}, endIdx = {}", beginIdx, endIdx);
        ...
        while (beginIdx != -1 && endIdx != -1 && endIdx > beginIdx) {
            ...
            if (exprFound) {
                ...
                logger.info("  Expression Found: {}", strExpr);
    ...
    private static String replaceExpressions(String value,
        ...
        for (Expression expr : expressions) {
            logger.info("replExprs: Loop for {}", expr.myExpression);
            int beginIdx = value.indexOf(Expression.BEGIN_EXPR);
            ...
            if (beginIdx != -1 && endIdx != -1 && endIdx > beginIdx) {
                ...
                logger.info("  Replacing \"{}\" with \"{}\".", replaceMe, replaceWith);
    ...
    private static RichTextString replaceExpressions(RichTextString richTextString,
        ...
        for (Expression expr : expressions) {
            logger.info("replExprsRTS: Loop for {}", expr.myExpression);
            ...
            logger.info("  replacement of \"{}\" with \"{}\".",
